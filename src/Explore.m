        ...
        function init(h,varargin)
            ...
            if h.status.plot
                ...
                leg = [plot(NaN,NaN,'LineStyle','-','Color',rgb('DarkGray'),'Marker','o','MarkerEdgeColor','none','MarkerFaceColor',rgb('DarkGray'),'DisplayName','Node - Not planned');...
                    plot(NaN,NaN,'LineStyle','-','Color',rgb('RoyalBlue'),'Marker','o','MarkerEdgeColor','none','MarkerFaceColor',rgb('RoyalBlue'),'DisplayName','Node - To be evaluated');...
                    plot(NaN,NaN,'LineStyle','-','Color',rgb('Orange'),'Marker','o','MarkerEdgeColor','none','MarkerFaceColor',rgb('Orange'),'DisplayName','Node - Being evaluated');...
                    plot(NaN,NaN,'LineStyle','-','Color',rgb('Green'),'Marker','o','MarkerEdgeColor','none','MarkerFaceColor',rgb('Green'),'DisplayName','Node - Has been evaluated');...
                    plot(NaN,NaN,'LineStyle','none','Marker','s','MarkerFaceColor','none','MarkerEdgeColor',rgb('Black'),'MarkerSize',12,'DisplayName','Box - No action');...
                    plot(NaN,NaN,'LineStyle','none','Marker','s','MarkerFaceColor','none','MarkerEdgeColor',rgb('Green'),'MarkerSize',12,'DisplayName','Box - Retrieve');...
                    plot(NaN,NaN,'LineStyle','none','Marker','s','MarkerFaceColor','none','MarkerEdgeColor',rgb('Orange'),'MarkerSize',12,'DisplayName','Box - Compute (code)');...
                    plot(NaN,NaN,'LineStyle','none','Marker','s','MarkerFaceColor','none','MarkerEdgeColor',rgb('RoyalBlue'),'MarkerSize',12,'DisplayName','Box - Compute (input)');...
